...
class Tagging
{
    ...
    {
        $url = Config::BASE_URL . Config::ENDPOINT_TAGGING_INDEX;
    ...
    {
        $url = Config::BASE_URL . Config::ENDPOINT_TAGGING_STORE;
    ...
    {
        $url = Helper::replace_uri_with_id(Config::BASE_URL . Config::ENDPOINT_TAGGING_UPDATE, $tag_id, '{tag_id}');
    ...
    {
        $url = Helper::replace_uri_with_id(Config::BASE_URL . Config::ENDPOINT_TAGGING_DESTROY, $tag_id, '{tag_id}');
